...
<div class="content poll-vote">
   ...
   <form >
        ...
        <label>
        <input type="radio" id="answer_1" name="answer_1" value="1" onclick="location.href='result1.php?id=<?=$poll['id'];?>&answer=1'">
    <label class="radio has-text-weight-bold" for="answer_1"> <?php echo ($poll['answer_1']); ?> </label><br>
    <input type="radio" id="answer_2" name="answer_2" value="2" onclick="location.href='result1.php?id=<?=$poll['id'];?>&answer=2'">
    <label class="radio has-text-weight-bold" for="answer_2"> <?php echo ($poll['answer_2']); ?> </label><br>
    <!-- 3 küsimust -->
    <?php if (strlen(trim($poll['answer_3'])) != 0) {
    ?>
    <input type="radio" id="answer_3" name="answer_3" value="3" onclick="location.href='result1.php?id=<?=$poll['id'];?>&answer=3'">
